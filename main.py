...
wandb.init(project='DtoS_Dataset')
...
def run_main():
    ...
    kihadataset_train,kihadataset_val = dataset_handler.run_k_fold_split(n_splits=5)
    ...
    if tuning == True:
           ...
           # Testing
            ...
            if individual_plot:
                for subject in config['test_subjects']:
                    ...
                    wandb_plotly_true_pred(y_true[subject_index], y_pred[subject_index], config['static_labels'], str('test_'+ subject))
        ...
        for activity in config['test_activity']:
            ...
            wandb_plotly_true_pred(y_true[activity_index], y_pred[activity_index],  config['static_labels'], 'test_' + activity_to_evaluate)
